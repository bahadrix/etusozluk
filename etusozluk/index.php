			...
			<table cellspacing=0 cellpadding=0>
				<tr>
					<td valign=top width=800 style="border-right:1px dotted #666;">
						...
						$baslikadihg = preg_replace('/ /','+',$baslikadi); //hepsi gelsin butonu için gerekiyor?
						?>
						<br /><div style="text-align:center;" id="hg"><?php if($var) { ?><button type="button" rel="goster.php?t=<?php echo $baslikadihg; ?>" id="ehg">Hepsi Gelsin</button>
